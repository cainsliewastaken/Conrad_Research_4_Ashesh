...
def RMSE(y_hat, y_true):
    return np.sqrt(np.mean(y_hat - y_true, axis=1, keepdims=True)**2 + np.finfo(float).eps) #change for different values of epsilon
...
ax3[0].loglog(u_1d_fspec_tdim[0,1:512], label='Truth at t=0')
...
ax3[0].loglog(direct_1d_fspec_tdim[0,1:512], label='Direct step at t=0')
ax3[0].loglog(direct_1d_fspec_tdim[10000,1:512], label='Direct step at t=10000')
...
ax3[1].loglog(PEC_1d_fspec_tdim[0,1:512], label='PEC step at t=0')
ax3[1].loglog(PEC_1d_fspec_tdim[10000,1:512], label='PEC step at t=10000')
...
ax3[1].set_title('Values of the fourier spectrum of u and PEC step at timesteps 0, 10k, 20k and 100k')
