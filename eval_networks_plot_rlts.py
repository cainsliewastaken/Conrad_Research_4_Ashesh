...
ax3[0,0].loglog(u_1d_fspec_tdim[-1,1:512], label='Truth at t=100000')
...
ax3[0,0].loglog(direct_1d_fspec_tdim[-1,1:512], label='Direct step at t=100000')
ax3[0,0].legend()
...
ax3[1,0].loglog(u_1d_fspec_tdim[-1,1:512], label='Truth at t=100000')
...
ax3[1,0].loglog(PEC_1d_fspec_tdim[-1,1:512], label='PEC step at t=100000')
ax3[1,0].legend()
...
ax4[0,0].loglog(u_truth_difft_n2_fspec[-1,1:512], label='Truth at t=100000')
...
ax4[0,0].loglog(u_direct_difft_n2_fspec[-1,1:512], label='Direct step at t=100000')
ax4[0,0].legend()
...
ax4[1,0].loglog(u_truth_difft_n2_fspec[-1,1:512], label='Truth at t=100000')
...
ax4[1,0].loglog(u_PEC_difft_n2_fspec[-1,1:512], label='PEC step at t=100000')
ax4[1,0].legend()
