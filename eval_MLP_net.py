...
net_file_name = "/home/exouser/conrad_net_stability/Conrad_Research_4_Ashesh/NN_Spectral_Loss_with_tendencyfft_lambda_reg5_directstep_lead1.pt" #change this to use a different network
...
eval_output_name = 'predicted_Directstep_1024_tendency_lead'+str(lead)+''  # what to name the output file, .mat ending not needed
