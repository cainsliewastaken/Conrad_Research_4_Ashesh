...
net_name = 'FNO_RK4step_lead'+str(lead)+'_tendency'

net_file_path = "/glade/derecho/scratch/cainslie/conrad_net_stability/model_chkpts/FNO_RK4step_lead1_tendency/chkpt_FNO_RK4step_lead1_tendency_epoch51.pt"
