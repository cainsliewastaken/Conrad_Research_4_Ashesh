...
net_file_name = "/home/exouser/conrad_net_stability/Conrad_Research_4_Ashesh/NN_FNO_PECstep_lead1_tendency_lambda10.pt"
...
eval_output_name = 'predicted_PECstep_1024_FNO_lead'+str(lead)+'_tendency_lambda10'  # what to name the output file, .mat ending not needed
