...
net_file_name = "/home/exouser/conrad_net_stability/Conrad_Research_4_Ashesh/NN_FNO_Directstep_lead1_tendency_lambda0.pt"
...
eval_output_name = 'predicted_Directstep_1024_FNO_tendency_lead'+str(lead)+'_lambda0'  # what to name the output file, .mat ending not needed
