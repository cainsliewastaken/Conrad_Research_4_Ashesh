...
mynet.load_state_dict(torch.load("/home/exouser/conrad_net_stability/Conrad_Research_4_Ashesh/NN_Spectral_Loss_FNO_Eulerstep_tendency_lambda_reg5lead1.pt"))
mynet.eval()
mynet.cuda()
...
for k in range(0,eq_points):
    ...
    temp_mat = torch.autograd.functional.jacobian(Eulerstep, torch.reshape(torch.tensor(x_torch[k,:]),(1,input_size,1)))
...
scipy.io.savemat(path_outputs+'FNO_KS_Eulerstep_tendency_lead'+str(lead)+'.mat', matfiledata)
