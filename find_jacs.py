...
mynet.load_state_dict(torch.load("/home/exouser/conrad_net_stability/Conrad_Research_4_Ashesh/NN_Spectral_Loss_with_tendencyfft_lambda_reg5_Eulerstep_lead1.pt"))
mynet.eval()
mynet.cuda()
...
scipy.io.savemat(path_outputs+'MLP_KS_Eulerstep_tendency_lead'+str(lead)+'.mat', matfiledata)
