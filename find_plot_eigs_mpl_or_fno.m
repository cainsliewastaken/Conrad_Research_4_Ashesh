...
% model_one = load('FNO_KS_Directstep_lead1_large_jacs.mat');
% model_two = load('FNO_KS_PECstep_lead1_large_jacs.mat');
% 
...
plot(e_direct_un,'ro','MarkerSize',10);

legend('Unit Circle','Direct Step','Direct untrained',fontsize=10)
...
plot(e_PEC,'ro','MarkerSize',5,'MarkerFaceColor','r');
plot(e_PEC_sl,'bo','MarkerSize',5);
plot(e_PEC_un,'ko','MarkerSize',5,'MarkerFaceColor','k');



% legend('Unit Circle','PEC Basic','PEC Spectral loss',fontsize=10)
legend('PEC Basic','PEC Spectral loss','PEC Untrained',fontsize=10)
...
% hold on;
% 
% plot(e_direct_un,'ro','MarkerSize',10,'MarkerFaceColor','r');
% 
% plot(e_PEC_un,'bo','MarkerSize',10);
% 
...
hold on
histogram(abs(e_direct_un), 25,Normalization="pdf")
