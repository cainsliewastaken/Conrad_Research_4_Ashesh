...
[v_direct, e_direct_un] = eig(squeeze(direct_step_jacs_untrained.Jacobian_mats(2,:,:)));
[e_direct_un, ind_d] = sort(diag(e_direct_un));
...
[v_PEC, e_PEC_un] = eig(squeeze(PEC_step_jacs_untrained.Jacobian_mats(1,:,:)));
[e_PEC_un, ind_p] = sort(diag(e_PEC_un));
